...
@section('title', 'Nilai Kokulikuler')
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="{{route('penilaian-kokulikuler.show', $pembelajaran->id)}}" onclick="return confirm('Reset Nilai ?')" type="button" class="btn btn-tool btn-sm">
            ...
            <table class="table table-bordered table-hover">
              <thead class="bg-primary">
                <tr>
                  ...
                  <input type="hidden" name="rencana_kokulikuler_id[]" value="{{$rencana_penilaian->rencana_kokulikuler_id}}">
                  @endforeach
                </tr>
              </thead>
              <tbody>
                ...
                <?php $i = -1; ?>
                  ...
                  <td>
                    <input type="number" class="form-control" name="nilai_npts[{{$i}}][]" min="0" max="100" value="{{$nilai->nilai_pts}}" oninvalid="this.setCustomValidity('Nilai harus berisi antara 0 s/d 100')" oninput="setCustomValidity('')">
                  </td>
                  <td>
      ...
      <div class="card-footer clearfix">
        ...
        <a href="{{ route('penilaian-kokulikuler.index') }}" class="btn btn-default float-right mr-2">Batal</a>
      </div>
      </form>
    </div>
    <!-- /.card -->
