...
<div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="multiple-submits" action="{{ route('penilaian-kokulikuler.store') }}" method="POST">
                @csrf
                  ...
                  <table class="table table-bordered table-hover">
                    <thead class="bg-primary">
                      <tr>
                        ...
                        <input type="hidden" name="rencana_kokulikuler_id[]" value="{{$rencana_penilaian->id}}">
                        @endforeach
                      </tr>
                    </thead>
                    <tbody>
