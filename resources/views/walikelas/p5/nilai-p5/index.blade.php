        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th rowspan="2" class="text-center" style="vertical-align: middle;">Profil Projek</th>
                ...
                <tr>
                    <th class="text-center" style="width: 100px;">Dimensi</th>
                ...
                <tr>
                    ...
                    <a href="{{ route('nilai-p5.edit', Crypt::encrypt($penilaian->id)) }}" type="button" class="btn btn-sm btn-primary">
