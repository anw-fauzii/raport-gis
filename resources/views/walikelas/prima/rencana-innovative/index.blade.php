...
@section('title', 'Rencana Innovative')
        ...
        <div class="card-header">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td class="text-center"><form action="{{ route('rencana-innovative.destroy', $data->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
...
@include('walikelas.prima.rencana-innovative.create')
@stop
