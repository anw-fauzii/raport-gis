...
@section('title', 'Rencana Proactive')
        ...
        <div class="card-header">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td class="text-center"><form action="{{ route('rencana-proactive.destroy', $data->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
...
@include('walikelas.prima.rencana-proactive.create')
@stop
