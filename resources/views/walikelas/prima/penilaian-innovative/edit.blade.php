  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('penilaian-innovative.update', $kelas->id) }}" method="POST">
          {{ method_field('PATCH') }}
          @csrf
            ...
            <table class="table table-bordered table-hover">
              <thead class="bg-primary">
                ...
                <tr>
                  ...
                  <input type="hidden" name="rencana_innovative_id[]" value="{{$kd_nilai->rencana_innovative_id}}">
                  <td class="text-center" style="width: 200px;"><a href="#" type="button"  class="btn btn-sm btn-primary" data-toggle="tooltip" title="{{$kd_nilai->rencana_innovative->butir_sikap->butir_sikap}}"><b>{{$kd_nilai->rencana_innovative->butir_sikap->kode}}</b></a></td>
                  @endforeach
                </tr>
              </thead>
              <tbody>
      ...
      <div class="card-footer clearfix">
        ...
        <a href="{{ route('penilaian-innovative.index') }}" class="btn btn-default float-right mr-2">Batal</a>
      </div>
      </form>
    </div>
    <!-- /.card -->
