            ...
            <table class="table table-bordered table-hover">
              <thead class="bg-primary">
                ...
                <tr>
                  ...
                  <td class="text-center" style="width: 200px;"><small></small> <button type="" class="btn btn-sm btn-primary" title="{{$kd_nilai->rencana_innovative->butir_sikap->butir_sikap}}">
                        <b>{{$kd_nilai->rencana_innovative->butir_sikap->kode}}</b>
                          </button></td>
                  @endforeach
                </tr>
              </thead>
