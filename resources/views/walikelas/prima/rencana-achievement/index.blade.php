...
@section('title', 'Rencana Achievement')
        ...
        <div class="card-header">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td class="text-center"><form action="{{ route('rencana-achievement.destroy', $data->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
...
@include('walikelas.prima.rencana-achievement.create')
@stop
