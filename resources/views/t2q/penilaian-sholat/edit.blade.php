  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('penilaian-sholat.update', $kelas->id) }}" method="POST">
          {{ method_field('PATCH') }}
          @csrf
            ...
            <table class="table table-bordered table-hover">
              <thead class="bg-primary">
                ...
                <tr>
                  ...
                  <input type="hidden" name="rencana_nilai_sholat_id[]" value="{{$kd_nilai->rencana_nilai_sholat_id}}">
                  <td class="text-center" style="width: 200px;"><small></small> <button type="" class="btn btn-sm btn-primary" title="{{$kd_nilai->rencana_nilai_sholat->butir_sikap->butir_sikap}}">
                        <b>{{$kd_nilai->rencana_nilai_sholat->butir_sikap->kode}}</b>
                          </button></td>
                  @endforeach
                </tr>
              </thead>
