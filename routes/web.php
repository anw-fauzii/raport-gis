...
Route::post('kelas/anggota', [App\Http\Controllers\KelasController::class,'store_anggota'])->name('kelas.anggota');
Route::delete('kelas/anggota/{id}', [App\Http\Controllers\KelasController::class,'delete_anggota'])->name('kelas.anggota.delete');
