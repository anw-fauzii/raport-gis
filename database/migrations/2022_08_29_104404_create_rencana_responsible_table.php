...
class CreateRencanaResponsibleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rencana_responsible', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('rencana_responsible');
    }
}
