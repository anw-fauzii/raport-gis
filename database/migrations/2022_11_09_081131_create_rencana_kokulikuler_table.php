...
class CreateRencanaKokulikulerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rencana_kokulikuler', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('rencana_kokulikuler');
    }
}
