...
class NilaiK4Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        if (is_null($request->anggota_kelas_id)) {
            ...
            return redirect('penilaian-k4')->with('success', 'Data nilai pengetahuan berhasil disimpan.');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('penilaian-k4')->with('success', 'Data nilai pengetahuan berhasil diedit.');
    }
