...
class NilaiMulokController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (is_null($request->anggota_kelas_id)) {
            ...
            return redirect('penilaian-mulok')->with('success', 'Data nilai pengetahuan berhasil disimpan.');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('penilaian-mulok')->with('success', 'Data nilai pengetahuan berhasil diedit.');
    }
